...
func (service *NFTCommandService) CreateNFTLogSetGreeting(ctx context.Context, txHash string, logIndex uint, contractAddress string, chain string, data types.CreateNFTLogSetGreeting) error {
